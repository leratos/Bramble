...
> 🌐 **English version: [README.md](README.md).** Diese Datei ist die deutsche
> Fassung und wird vom Maintainer gepflegt; bei Abweichungen ist die
> englische README maßgeblich.
...
Default `Europe/Berlin`) und ohne Sekunden dargestellt. Die UI ist
standardmäßig englisch; mit `--language de` (Env `BRAMBLE_ADMIN_LANGUAGE`)
auf Deutsch.
...
Bramble/
├── docs/
│   ├── concepts/        # Phasen-Konzepte (intern, deutsch)
│   ├── ai-client-setup.md
